...
public:
    ...
    std::vector<std::uint8_t> fetch(LyricSource source, std::string_view keywordUtf8, std::string_view qqCookieUtf8) const;

private:
    std::vector<std::uint8_t> fetchQQ(std::string_view keywordUtf8, std::string_view cookieUtf8) const;
