...
WINRT_EXPORT namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Windows::AI::ModelContextProtocol::IModelContextProtocolClientContext>
    {
        ...
        {
            virtual std::int32_t __stdcall put_OwnerWindowId(struct struct_Windows_UI_WindowId) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::AI::ModelContextProtocol::IModelContextProtocolServer>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall GetCommandArguments(std::uint32_t* __resultSize, void***) noexcept = 0;
    ...
    template <> struct abi<winrt::Windows::AI::ModelContextProtocol::IModelContextProtocolServerCatalog>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            virtual std::int32_t __stdcall GetServerInfos(std::uint32_t* __resultSize, void***) noexcept = 0;
            virtual std::int32_t __stdcall ActivateServer(winrt::guid, void*, void**) noexcept = 0;
            virtual std::int32_t __stdcall CreateClientContext(void**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::AI::ModelContextProtocol::IModelContextProtocolServerInfo>
    {
        struct WINRT_IMPL_ABI_DECL type : inspectable_abi
        {
            ...
            virtual std::int32_t __stdcall GetPackage(void**) noexcept = 0;
        };
    };
