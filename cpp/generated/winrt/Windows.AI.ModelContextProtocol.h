...
WINRT_EXPORT namespace winrt::impl
{
    ...
    {
        consume_general<winrt::Windows::AI::ModelContextProtocol::IModelContextProtocolClientContext, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::AI::ModelContextProtocol::IModelContextProtocolClientContext>::put_OwnerWindowId, impl::bind_in(value));
    }
    template <typename D> auto consume_Windows_AI_ModelContextProtocol_IModelContextProtocolClientContext<D>::OwnerWindowId() const
    {
        ...
        consume_general<winrt::Windows::AI::ModelContextProtocol::IModelContextProtocolClientContext, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::AI::ModelContextProtocol::IModelContextProtocolClientContext>::get_OwnerWindowId, put_abi(value));
        return value;
    }
    template <typename D> auto consume_Windows_AI_ModelContextProtocol_IModelContextProtocolServer<D>::Command() const
    {
        void* value{};
        consume_general<winrt::Windows::AI::ModelContextProtocol::IModelContextProtocolServer, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::AI::ModelContextProtocol::IModelContextProtocolServer>::get_Command, &value);
    ...
    template <typename D> auto consume_Windows_AI_ModelContextProtocol_IModelContextProtocolServer<D>::GetCommandArguments() const
    {
        ...
        void** result{};
        consume_general<winrt::Windows::AI::ModelContextProtocol::IModelContextProtocolServer, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::AI::ModelContextProtocol::IModelContextProtocolServer>::GetCommandArguments, &result_impl_size, &result);
    ...
    {
        void* value{};
        consume_general<winrt::Windows::AI::ModelContextProtocol::IModelContextProtocolServer, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::AI::ModelContextProtocol::IModelContextProtocolServer>::get_Info, &value);
    ...
    template <typename D> auto consume_Windows_AI_ModelContextProtocol_IModelContextProtocolServerCatalog<D>::GetServerInfos() const
    {
        std::uint32_t result_impl_size{};
        void** result{};
        consume_general<winrt::Windows::AI::ModelContextProtocol::IModelContextProtocolServerCatalog, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::AI::ModelContextProtocol::IModelContextProtocolServerCatalog>::GetServerInfos, &result_impl_size, &result);
    ...
    {
        void* result{};
        consume_general<winrt::Windows::AI::ModelContextProtocol::IModelContextProtocolServerCatalog, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::AI::ModelContextProtocol::IModelContextProtocolServerCatalog>::ActivateServer, impl::bind_in(serverId), *(void**)(&client), &result);
    ...
    {
        void* result{};
        consume_general<winrt::Windows::AI::ModelContextProtocol::IModelContextProtocolServerCatalog, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::AI::ModelContextProtocol::IModelContextProtocolServerCatalog>::CreateClientContext, &result);
    ...
    {
        winrt::guid value{};
        consume_general<winrt::Windows::AI::ModelContextProtocol::IModelContextProtocolServerInfo, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::AI::ModelContextProtocol::IModelContextProtocolServerInfo>::get_Id, put_abi(value));
        return value;
    }
    template <typename D> auto consume_Windows_AI_ModelContextProtocol_IModelContextProtocolServerInfo<D>::Name() const
    {
        void* value{};
        consume_general<winrt::Windows::AI::ModelContextProtocol::IModelContextProtocolServerInfo, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::AI::ModelContextProtocol::IModelContextProtocolServerInfo>::get_Name, &value);
        return hstring{ value, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_AI_ModelContextProtocol_IModelContextProtocolServerInfo<D>::Description() const
    {
        void* value{};
        consume_general<winrt::Windows::AI::ModelContextProtocol::IModelContextProtocolServerInfo, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::AI::ModelContextProtocol::IModelContextProtocolServerInfo>::get_Description, &value);
        return hstring{ value, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_AI_ModelContextProtocol_IModelContextProtocolServerInfo<D>::GetPackage() const
    {
        void* result{};
        consume_general<winrt::Windows::AI::ModelContextProtocol::IModelContextProtocolServerInfo, D>(static_cast<D const*>(this), &abi_t<winrt::Windows::AI::ModelContextProtocol::IModelContextProtocolServerInfo>::GetPackage, &result);
    ...
    {
        std::int32_t __stdcall put_OwnerWindowId(struct struct_Windows_UI_WindowId value) noexcept final try
        {
    ...
    struct produce<D, winrt::Windows::AI::ModelContextProtocol::IModelContextProtocolServer> : produce_base<D, winrt::Windows::AI::ModelContextProtocol::IModelContextProtocolServer>
    {
        ...
        std::int32_t __stdcall GetCommandArguments(std::uint32_t* __resultSize, void*** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
    ...
    {
        std::int32_t __stdcall GetServerInfos(std::uint32_t* __resultSize, void*** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall ActivateServer(winrt::guid serverId, void* client, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
        ...
        std::int32_t __stdcall CreateClientContext(void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
    ...
    struct produce<D, winrt::Windows::AI::ModelContextProtocol::IModelContextProtocolServerInfo> : produce_base<D, winrt::Windows::AI::ModelContextProtocol::IModelContextProtocolServerInfo>
    {
        ...
        std::int32_t __stdcall GetPackage(void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
